...
//detta kan man lägga till senare:
    ...
    public Message(string id, string content, DateTime dateCreated, string conversationParticipantId, string conversationId) { 
        Id = id;
        Content = content;
        DateCreated = dateCreated;
        ConversationParticipantId = conversationParticipantId;
            ConversationParticipantId = conversationId;
    }
}
