...
builder.Services.AddScoped<IProfileSurveyRepository, ProfileSurveyRepository>();
...
builder.Services.AddScoped<ISurveyService, HealthCheckService>();
builder.Services.AddScoped<IProfileSurveyService, ProfileHealthCheckService>();
