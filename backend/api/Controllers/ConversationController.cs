...
namespace Controllers
{
    ...
    public class ConversationController : ControllerBase
    {
        ...
        public ConversationController(JwtService jwtService, IConversationService conversationService, IProfileService profileService, IUserService userService)
        {
...
public async Task<ActionResult<Conversation>> AddProfileToConversation([FromBody] AddProfileToConversationDTO addProfileToConversationDTO)
{
    try
    {
        ...
        var addedProfile = await _conversationService.ManualAddProfileToConversationAsync(addProfileToConversationDTO.ConversationParticipantId, addProfileToConversationDTO.ProfileId);
